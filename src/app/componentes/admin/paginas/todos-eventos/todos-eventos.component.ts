...
import { equiposCargados } from 'src/app/state/actions/equipos.actions';
...
export class TodosEventosComponent implements OnInit, OnDestroy {
  ...
  SuscripcionTodosEventos: Subscription = new Subscription();
  SuscripcionTodosFixed: Subscription = new Subscription();
  SuscripcionConsultaUno: Subscription = new Subscription();
  SuscripcionConsultaDos: Subscription = new Subscription();
  SuscripcionConsultaTres: Subscription = new Subscription();
  ...
  ngOnDestroy(): void {
    console.log('unsubscribe todos los eventos component');

    this.SuscripcionTodosEventos.unsubscribe();
    this.SuscripcionTodosFixed.unsubscribe();
    this.SuscripcionConsultaUno.unsubscribe();
    this.SuscripcionConsultaDos.unsubscribe();
    this.SuscripcionConsultaTres.unsubscribe();
  }

  ngOnInit(): void {
    this.SuscripcionTodosFixed = this._socket
      .updateFix$()
      .subscribe((res) => {});

    this.SuscripcionTodosEventos = this._socket
      .getPartidos$()
      .subscribe((res) => {
        ...
        this._store.dispatch(
          partidosCargados({ partidosLista: res.data.data })
        );
      });

    this.SuscripcionConsultaUno = this._todosEventosService
      .getAllPaises()
      .subscribe((res) => {
    ...
    this.SuscripcionConsultaDos = this._todosEventosService
      ...
      .subscribe((res) => {
        if (!res.data.procede) {
          ...
          this.SuscripcionConsultaTres = this._todosEventosService
